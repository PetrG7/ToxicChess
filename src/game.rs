            ...
            match piece_type {
                ...
                PieceType::Knight => {
                	...
                	if piece.get_x() + 2 <= 72 {
                		...
                		if piece.get_y() < 8 && !self_occupied.contains(&Square { x: piece.get_x() + 2, y: piece.get_y() + 1}){
                			legal_moves.push((piece, Square { x: piece.get_x() + 2, y: piece.get_y() + 1}));
                		}
                		if piece.get_y() > 1 && !self_occupied.contains(&Square { x: piece.get_x() + 2, y: piece.get_y() - 1}){
                			legal_moves.push((piece, Square { x: piece.get_x() + 2, y: piece.get_y() - 1}));
                		}
                	}
                	if piece.get_x() - 2 >= 65 {
                	...
                	if piece.get_y() + 2 <= 8 {
                		if piece.get_x() < 72 && !self_occupied.contains(&Square { x: piece.get_x() + 1, y: piece.get_y() + 2}){
                			legal_moves.push((piece, Square { x: piece.get_x() + 1, y: piece.get_y() + 2}));
                		}
                		if piece.get_x() > 65 && !self_occupied.contains(&Square { x: piece.get_x() - 1, y: piece.get_y() + 2}){
                			legal_moves.push((piece, Square { x: piece.get_x() - 1, y: piece.get_y() + 2}));
                		}
                	}
                	if piece.get_y() - 2 >= 1 {
